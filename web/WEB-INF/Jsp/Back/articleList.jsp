                    ...
                    <li class="am-dropdown tpl-dropdown" data-am-dropdown>
                        ...
                        <ul class="am-dropdown-content tpl-dropdown-content">
                            ...
                            <li class="tpl-dropdown-menu-messages">
                                <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                    <div class="menu-messages-ico">
                                        <img src="${pageContext.request.contextPath}/Resources/Adminassets/img/user02.png" alt="">
                                    </div>
                                    <div class="menu-messages-time">
                                        5天前
                                    </div>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                    <li class="sidebar-nav-link">
                        <a href="${pageContext.request.contextPath}/admin/articlelist" class="sub-active">
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/admin/delectarticle/${article.articleid}" class="tpl-table-black-operation-del">
